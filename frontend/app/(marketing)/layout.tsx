...
import { Menu, X, Sparkles, LayoutDashboard, ArrowRight, User } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 flex h-16 items-center justify-between">
          <Link href="/" className="flex items-center space-x-2 group">
            <div className="relative">
              <Image src="/logo.png" alt="RecapVideo" width={32} height={32} className="rounded transition-transform group-hover:scale-110" />
          ...
          <div className="grid gap-10 grid-cols-2 md:grid-cols-4">
            <div className="col-span-2 md:col-span-1">
              <Link href="/" className="flex items-center space-x-2 mb-4 group">
                <Image src="/logo.png" alt="RecapVideo" width={28} height={28} className="rounded" />
