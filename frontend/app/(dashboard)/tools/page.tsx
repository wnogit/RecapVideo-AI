...
const tools = [
    ...
    },
    {
        id: 'script-writer',
        name: 'Script Writer',
        description: 'Generate video scripts from topic or URL',
        longDescription: 'Topic သို့မဟုတ် video URL မှ script ထုတ်ပေးပါသည်။ Multiple script types နှင့် tone customization ရှိပါသည်။',
        icon: PenTool,
        credits: 3,
        status: 'available' as const,
