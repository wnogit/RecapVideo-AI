            ...
            <div className="border-t pt-4">
              ...
              <div className="grid grid-cols-3 gap-2 text-xs">
                <div className="bg-muted/50 rounded-md p-2">
                  ...
                  <p className="font-medium">{(video as any).aspect_ratio || '9:16'}</p>
                </div>
                <div className="bg-muted/50 rounded-md p-2">
                  <p className="text-muted-foreground">Voice</p>
                  <p className="font-medium">{(video as any).voice_id || 'Default'}</p>
                </div>
                <div className="bg-muted/50 rounded-md p-2">
                  <p className="text-muted-foreground">Subtitles</p>
                  <p className="font-medium">{(video as any).subtitles_enabled ? 'Yes' : 'No'}</p>
                </div>
              </div>
            </div>
