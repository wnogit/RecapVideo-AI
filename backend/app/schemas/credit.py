...
CREDIT_PACKAGES = [
    CreditPackage(
        ...
        price_usd=4.99,
        price_mmk=15000,
        description="Perfect for trying out (5 Videos)",
    ),
    CreditPackage(
        id="basic",
        name="Basic",
        ...
        price_mmk=40000,
        discount_percent=13,
        description="Most popular for beginners (15 Videos)",
    ),
    CreditPackage(
        id="pro",
        name="Pro",
        ...
        popular=True,
        discount_percent=20,
        description="Best value for creators (50 Videos)",
    ),
    CreditPackage(
        id="business",
        name="Business",
        ...
        price_mmk=300000,
        discount_percent=33,
        description="For professional use (150 Videos)",
    ),
]
